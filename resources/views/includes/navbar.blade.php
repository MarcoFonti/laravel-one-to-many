    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    {{-- ROTTA HOME GUEST --}}
                    <a class="nav-link @if (Route::is('guest.home'))
                        active
                    @endif" href="{{url('/') }}">{{ __('Home') }}</a>
                </li>
                <li class="nav-item">
                    {{-- ROTTA INDEX GUEST --}}
                    <a class="nav-link @if (Route::is('guest.projects.index'))
                        active
                    @endif" href="{{ route('guest.projects.index') }}">{{ __('Progetti') }}</a>
                </li>
                @auth   
                <li class="nav-item">
                    {{-- ROTTA INDEX ADMIN --}}
